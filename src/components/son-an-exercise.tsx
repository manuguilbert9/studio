...
export function SonAnExercise() {
    ...
    const checkAnswer = (selectedOption: 'an' | 'en' | 'am' | 'em') => {
        if (feedback) return;
    ...
    return (
        <div className="w-full max-w-2xl mx-auto">
            ...
            <Card className="shadow-2xl text-center relative overflow-hidden">
                ...
                <CardHeader>
                    <CardTitle className="font-headline text-2xl">Complète le mot avec le bon son [an]</CardTitle>
                </CardHeader>
                <CardContent className="min-h-[250px] flex flex-col items-center justify-center gap-8 p-6">
                    ...
                    <div className="grid grid-cols-4 gap-4 w-full max-w-md">
                        {(['an', 'en', 'am', 'em'] as const).map(option => (
                             <Button
                                key={option}
                                variant="outline"
