...
export function TimerWidget({ initialState, onUpdate, onClose }: TimerWidgetProps) {
  ...
  return (
    ...
    >
        ...
        >
            <Card
                className="w-full h-full p-4 bg-white/90 backdrop-blur-sm rounded-lg flex items-center gap-4 border border-transparent group-hover:shadow-lg group-hover:border-slate-300 transition-all"
            >
                <div
                    className="p-1 cursor-grab self-stretch flex items-center opacity-0 group-hover:opacity-100 transition-opacity"
                >
