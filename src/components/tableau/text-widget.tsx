...
export function TextWidget({ initialState, onUpdate, onClose }: TextWidgetProps) {
  ...
  return (
    ...
    >
      ...
      >
        <Card className="w-full h-full p-2 bg-white/95 backdrop-blur-sm rounded-lg flex flex-col items-start gap-2 select-none border border-transparent group-hover:shadow-lg group-hover:border-slate-300 transition-all">
          <div
